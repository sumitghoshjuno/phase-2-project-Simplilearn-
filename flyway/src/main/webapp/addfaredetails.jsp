...
<%@page import="com.flyway.Dao.Utils"%>
	...
	<footer>
		<div class="row justify-content-center">
			<div class="col-md-5 text-center">
				...
				<p>
					<i class="fas fa-phone-square pr-2 fa-2x text-success"></i>{747}
					898-8888
				</p>
				<p>
					<i class="fas fa-envelope-open-text pr-2 fa-2x text-success"></i>support@flyway.com
				</p>

			</div>

			<hr class="socket">
			<p>&copy; Flyway, All Rights Reserved</p>
		</div>
	</footer>
