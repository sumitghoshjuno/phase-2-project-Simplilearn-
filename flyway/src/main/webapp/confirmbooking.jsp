...
<%@page import="com.flyway.model.Customer"%>
<%@page import="com.flyway.model.Airport"%>
<%@page import="com.flyway.Dao.CustomerDAO"%>
<%@page import="com.flyway.model.Fare"%>
<%@page import="com.flyway.model.Flight"%>
